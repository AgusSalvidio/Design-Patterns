# How to load Design-Patterns in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      ...
      repository: 'github://AgusSalvidio/Design-Patterns:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `AgusSalvidio` as owner name and `Design-Patterns`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Design-Patterns ...*
